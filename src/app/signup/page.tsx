...
export default function SignupPage() {
    ...
    const [learnerType, setLearnerType] = useState('Student');
    ...
    return (
        <div className="flex h-screen w-full items-center justify-center bg-background p-4 md:p-8">
            <div className="flex w-full max-w-4xl overflow-hidden rounded-2xl shadow-lg">
                ...
                <div className="w-full bg-card p-8 md:w-1/2">
                    <div className="mx-auto flex h-full max-w-sm flex-col justify-center">
                        <div>
                            <h2 className="text-2xl font-bold text-textPrimary">Let’s level up your learning, together</h2>
                            <p className="mt-2 text-textSecondary">
                                You can reach us anytime via hi@sanjog.com
                            </p>
                        </div>
