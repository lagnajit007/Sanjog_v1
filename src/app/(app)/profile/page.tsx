...
const EditProfileModal = ({ isOpen, onClose, user, onSave }: { isOpen: boolean, onClose: () => void, user: ProfileData, onSave: (updatedUser: { name: string, tagline: string, avatar: string }) => void }) => {
